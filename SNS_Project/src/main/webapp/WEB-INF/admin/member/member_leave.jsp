              ...
              <div class="row align-items-center">
                  <div class="col-md-8">
                      <div class="page-header-title">
                          <h5 class="m-b-10">탈퇴회원조회</h5>
                          <p class="m-b-0">Search for members who have left</p>
                      </div>
                  </div>
                  <div class="col-md-4">
                      <ul class="breadcrumb">
                          ...
                          <li class="breadcrumb-item">탈퇴회원조회</li>
                      </ul>
                  </div>
              </div>
          </div>
	                              ...
	                              <table class="table table-hover">
	                                  ...
	                                  <tbody>
	                                      ...
	                                      <tr>
	                                          ...
	                                          <td>
	                                          	<fmt:parseDate var="reg" value="${leave.reg_date }" pattern="yyyy-mm-dd"/>
	                                          	<fmt:formatDate value="${reg }" pattern="yyyy-mm-dd"/>
	                                          </td>
	                                          <td>
	                                          	<fmt:parseDate var="unreg" value="${leave.unreg_date }" pattern="yyyy-mm-dd"/>
	                                          	<fmt:formatDate value="${unreg }" pattern="yyyy-mm-dd"/>
	                                          </td>
