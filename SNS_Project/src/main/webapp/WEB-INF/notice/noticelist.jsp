  ...
  <div class="pcoded-content">
              ...
              <div class="row align-items-center">
                  <div class="col-md-8">
                      <div class="page-header-title">
                          <h5 class="m-b-10">notice 게시글</h5>
                          <p class="m-b-0">notice page</p>
                      </div>
                  </div>
                  <div class="col-md-4">
                      <ul class="breadcrumb">
                          ...
                          <li class="breadcrumb-item">notice 게시글</li>
                      </ul>
                  </div>
              </div>
          </div>
      ...
      <div class="pcoded-inner-content">
        ...
        <div id="inner-wrapper">
          <div id="inner-main">
            <div class="card">
            <h2 style="align-self: center;">공지사항 목록(공지사항 갯수 : ${totalCount })</h2>
			   ...
			   <a href="insert.nt" style="float: right;"><button type="button" style="align-items: flex-end;" class="w-btn w-btn-red" type="button">글쓰기</button></a>
              </div>
	...
	<c:forEach var="notice" items="${lists }" >
		<div class="col">
			 ...
			 <div class="card">
					...
					<a href="content.nt?pageNumber=${pageInfo.pageNumber}&num=${notice.num }" class="product-img"> <!--Image--> 
				...
				<div class="card-body">
					<!--Product Name-->
					<h6 class="card-title">
						<a class="text-uppercase fw-normal" href="content.nt?num=${notice.num }&pageNumber=${pageInfo.pageNumber}">${notice.title}</a>
					</h6>
					<!--End Product Name-->
					<!--Product Price-->
