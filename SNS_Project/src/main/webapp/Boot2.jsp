...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/Boot/bootstrap.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/Boot/bootstrap-icons.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/Boot/prism-okaidia.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/Boot/custom.min.css">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="download">Litera</a>
              <div class="dropdown-menu" aria-labelledby="download">
                <a class="dropdown-item" rel="noopener" target="_blank" href="https://jsfiddle.net/bootswatch/fz9q2h8u/">Open in JSFiddle</a>
                <div class="dropdown-divider"></div>
