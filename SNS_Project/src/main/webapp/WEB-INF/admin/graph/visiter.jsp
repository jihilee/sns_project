              ...
              <div class="row align-items-center">
                  <div class="col-md-8">
                      <div class="page-header-title">
                          <h5 class="m-b-10">방문자수 그래프 및 통계</h5>
                  ...
                  <div class="col-md-4">
                      <ul class="breadcrumb">
                          ...
                          <li class="breadcrumb-item">방문자수 그래프 및 통계</li>
                      </ul>
                  </div>
              </div>
          </div>
							...
							$(document).ready(function(){
								...
								$.ajax({
									...
									success : function(map) {
										...
										if(map.visiter != null && map.visiter != "") {
											console.log("visiter chart")

											$.each(map.visiter, function(index, item) {
												console.log(item.visit_date);
												var date = item.visit_date.split(" ")[0];
												console.log(date);
										...
										if(map.memberAge != null && map.memberAge != "") {
											console.log("member age chart")
											
											$.each(map.memberAge, function(index, item){
												console.log(item.age);
												console.log(item.cnt);
												
												chart2Label.push(item.age);
												chart2data.push(item.cnt);
											});
                          ...
                          <div class="col-md-12 col-lg-12">
	                          <div class="card">
	                              <div class="card-header">
	                                  ...
	                                  <span>년도와 월을 선택하면 해당하는 월의 날짜별 방문자 수를 그래프로 볼 수 있습니다.</span><br>
	                                  <div class="col-md-6 col-lg-6">
	                                    <div class="row">
	                                  	    <input type="month" class="form-control date" value="${today }" max="${today }"/>
	                                  	    <button class="btn waves-effect waves-light btn-inverse btn-outline-inverse form-control" onclick="visiter()">선택</button>
	                                    </div>
	                                  </div>
	                                  <span id="period"></span>
	                              </div>
                          ...
                          <div class="col-md-12 col-lg-6">
	                          <div class="card">
	                              <div class="card-header">
	                                  ...
	                                  <span>오늘 방문자 수를 나이대별로 나누어서 나타냅니다.</span><br>
	                              </div>
	                              <div class="card-block">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="card text-center order-visitor-card">
                                          <div class="card-block">
                                              <h6 class="m-b-0">어제 방문자수</h6>
                                              <h4 class="m-t-15 m-b-15"><i class="fa fa-user m-r-15 text-c-black"></i>${yesterday_visiter }</h4>
                                              <p class="m-b-0">어제 방문자수는 <b>${yesterday_visiter }명</b> 입니다.</p>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="card text-center order-visitor-card">
                                          <div class="card-block">
                                              <h6 class="m-b-0">오늘 방문자수</h6>
                                              <c:if test="${yesterday_visiter < today_visiter }">
                                              	<h4 class="m-t-15 m-b-15">
                                              		<i class="fa fa-arrow-up m-r-15 text-c-green"></i>${today_visiter-yesterday_visiter }
                                              	</h4>
                                              </c:if>
                                              <c:if test="${yesterday_visiter == today_visiter }">
                                              	<h4 class="m-t-15 m-b-15">
                                              		<i class="fa fa-user m-r-15 text-c-black"></i>${yesterday_visiter-today_visiter }
                                              	</h4>
                                              </c:if>
                                              <c:if test="${yesterday_visiter > today_visiter }">
                                              	<h4 class="m-t-15 m-b-15">
                                              		<i class="fa fa-arrow-down m-r-15 text-c-red"></i>${yesterday_visiter-today_visiter }
                                              	</h4>
                                              </c:if>
                                              <p class="m-b-0">오늘 방문자수는 <b>${today_visiter }명</b> 입니다.</p>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
