...
<br>
	<div style="margin: 50px 300px;">
		<form:form commandName="notice" method="post" action="update.nt" enctype="multipart/form-data">
			<div class="container">
				<div class="row">
					<center><h2 style="padding-left: 150px;">공지사항 수정</h2></center>			
				</div>
			</div>
			
			<input type="hidden" name="num" value="${notice.num}">
			<input type="hidden" name="pageNumber" value="${pageNumber}">
			<input type="hidden" name="originalImg" value="${notice.nfile}">
			...
			<div class="container" style="width:600px;">
				<div class="row">
					...
					<div class="row" style="margin-bottom: 15px;">
						<strong>제 목</strong>	
						<input type="text" size="50" maxlength="50" name="title" value="${notice.title}">
						<form:errors cssClass="err" path="title"/>
					</div>
				
					<div class="row" style="margin-bottom: 15px;">
						<strong>작성자</strong><br>	
						<input type="text" size="30" maxlength="10" name="" value="관리자" readonly>
					</div>
					...
					<div class="row" style="margin-bottom: 15px;">
						...
						<input type="text" size="50" maxlength="50" name="upload_date" value="${newformattedDay}" placeholder="YYYY-MM-DD">
						<form:errors cssClass="err" path="upload_date"/>
					</div>
					
					<div class="row" style="margin-bottom: 15px;">
						<strong>이벤트 이미지</strong><br>
						<img align="center" height="250" width="150" src="${pageContext.request.contextPath}/resources/images/${notice.nfile}">
						<input type="file"   name="upload" id="upload"  value="${notice.upload }"><br>
	       				<form:errors cssClass="err" path="nfile" />
					</div>
					
					<div class="row" style="margin-bottom: 15px;">
						<strong>내 용</strong>
						<textarea name="contents" id="abc" rows="13" cols="50">${notice.contents}</textarea><br>
				...
				<div class="row">
					...
					<div class="col" style="margin-bottom: 15px;">
						<input type="button" value="목록보기"  OnClick="window.location='list.nt?pageNumber=${pageNumber}'"> 
					</div>
				</div>
			</div>
		</form:form>
